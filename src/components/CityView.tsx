  ...
  return (
    ...
    <div className="-mb-24 flex h-dvh flex-col overflow-hidden">
      ...
      <div className="relative min-h-0 flex-1">
        ...
        <div className="pointer-events-none absolute right-2 top-2 z-[400] flex items-center gap-1.5 rounded-full bg-white/90 px-3 py-1.5 text-xs font-semibold text-gray-700 shadow">
